...
namespace Readify.DAL.Migrations
{
    ...
    [Migration("20250511180136_AddConversationAndMessageTable")]
    partial class AddConversationAndMessageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Readify.DAL.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Readify.DAL.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Readify.DAL.Entities.ReturnRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Readify.DAL.Entities.Message", b =>
                {
                    b.HasOne("Readify.DAL.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Readify.DAL.Entities.Identity.ApplicationUser", "Librarian")
                        .WithMany()
            ...
            modelBuilder.Entity("Readify.DAL.Entities.ReturnRequest", b =>
                {
                    b.HasOne("Readify.DAL.Entities.BorrowedBook", "BorrowedBook")
